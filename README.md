...
- **🗂️ 个人工作台**（纯本地，无后端）：底部「工作台」标签内聚合四件套 ——
  ...
  - **🎓 408 辅导工作台**（整合「408 考研专属辅导」技能，纯本地伴侣）：工作台内第 5 个子面板。状态概览（技能调用 / 知识点 / 今日待复习 / 连续天数）+ 掌握度分布；四大技能入口（费曼答疑 / 知识索引 / 定期归纳 / 复习提醒）一键复制规范提示词，去新对话粘贴给 408 专家执行；快捷操作（记录知识点、抽真题、标记今日复习完成）；知识索引（按科目→章节→知识点→掌握度+下次复习），按艾宾浩斯 R1-R5（1/3/7/16/35 天）自动排复习；近期活动记录可回填 AI 结果。
